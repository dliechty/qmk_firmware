...
LGUI_T(KC_Z),      LALT_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              LSFT_T(KC_H),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
...
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,              \
